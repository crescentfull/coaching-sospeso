...
describe("SospesoApplicationDashboard", () => {
  test("소스페소에 신청한 목록을 볼 수 있다", async () => {
    ...
    expect(tableToMarkdown(queryTL.table("").get())).toMatchInlineSnapshot(`
      ...
      | ---------------------- | ------------ | --------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ---------------------- |
      | 퀴어 문화 축제 올 사람 | 2024. 11. 6. |      김토끼rabbit@test.com010-1234-5678 | 저는 김씨가문 김유신의 52대손으로 태어나 어쩌구... 올해 퀴어 문화 축제에도 다녀왔으며, 모든 성소수자들을 지지합니다. | 신청함승인하기거절하기 |
      | 퀴어 문화 축제 올 사람 | 2024. 11. 5. |                     혐오자010-0000-0000 |                                                                   저는 소스페소에 이상한 요청을 보낸 나쁜 사람입니다 |                 거절됨 |
      |    시각 장애가 있는 분 | 2024. 11. 5. | 해적 토끼pirate@rabbit.com010-9876-5432 |                                                          제 왼쪽 눈을 보십시오. 이것이야 말로 증거가 아니겠습니까?ㄷ | 승인됨거절하기사용하기 |
      "
    `);
  });
